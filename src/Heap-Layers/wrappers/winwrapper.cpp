...
#define INTERPOSE(x) {#x, (FARPROC) winwrapper_##x, nullptr, false, 0}
#define INTERPOSE2(x,y) {x, (FARPROC) y, nullptr, false, 0}
...
static Patch rls_patches[] = 
  {
    ...
    {"??2@YAPAXI@Z",    (FARPROC) xxmalloc, nullptr, false, 0},
    {"??_U@YAPAXI@Z",   (FARPROC) xxmalloc, nullptr, false, 0},
    {"??3@YAXPAX@Z",    (FARPROC) xxfree,   nullptr, false, 0},
    {"??_V@YAXPAX@Z",   (FARPROC) xxfree,   nullptr, false, 0},
    ...
    {"??2@YAPAXIABUnothrow_t@std@@@Z",  (FARPROC) xxmalloc, nullptr, false, 0},
    {"??_U@YAPAXIABUnothrow_t@std@@@Z", (FARPROC)xxmalloc,  nullptr, false, 0},
    {"??3@YAXPAXABUnothrow_t@std@@@Z",  (FARPROC)xxfree,    nullptr, false, 0},
    {"??_V@YAXPAXABUnothrow_t@std@@@Z", (FARPROC)xxfree,    nullptr, false, 0},

    // Other malloc API friends.

    {"_msize",	(FARPROC) xxmalloc_usable_size, nullptr, false, 0},
    INTERPOSE(calloc),
    {"_calloc_base",(FARPROC) WINWRAPPER_PREFIX(calloc), nullptr, false, 0},
    {"_calloc_crt",(FARPROC) WINWRAPPER_PREFIX(calloc),  nullptr, false, 0},
    {"_calloc_impl",(FARPROC) WINWRAPPER_PREFIX(calloc), nullptr, false, 0},
    INTERPOSE(_expand),
    ...
    INTERPOSE(realloc),
    {"_realloc_base",(FARPROC) WINWRAPPER_PREFIX(realloc), nullptr, false, 0},
    {"_realloc_crt",(FARPROC) WINWRAPPER_PREFIX(realloc), nullptr, false, 0},
    {"_realloc_impl",(FARPROC) WINWRAPPER_PREFIX(realloc), nullptr, false, 0},
    INTERPOSE2("free", xxfree),
    INTERPOSE2("_free_base", xxfree),
    INTERPOSE2("_free_crt", xxfree),
    INTERPOSE2("_free_impl", xxfree),
    INTERPOSE(_recalloc),
    {"_recalloc_base", (FARPROC) WINWRAPPER_PREFIX(_recalloc), nullptr, false, 0},
    {"_recalloc_crt", (FARPROC) WINWRAPPER_PREFIX(_recalloc), nullptr, false, 0},
    {"_recalloc_impl", (FARPROC) WINWRAPPER_PREFIX(_recalloc), nullptr, false, 0},
    ...
    ,{"RtlAllocateHeap",  (FARPROC) WINWRAPPER_PREFIX(RtlAllocateHeap), nullptr, false, 0},
    ...
    {"RtlFreeHeap",    (FARPROC) WINWRAPPER_PREFIX(RtlFreeHeap), nullptr, false, 0},
    {"RtlSizeHeap",    (FARPROC) WINWRAPPER_PREFIX(RtlSizeHeap), nullptr, false, 0}
#endif

#if 1
    // Windows Heap API

    ,{"HeapAlloc",	(FARPROC) WINWRAPPER_PREFIX(HeapAlloc), nullptr, false, 0},
    {"HeapCompact",	(FARPROC) WINWRAPPER_PREFIX(HeapCompact), nullptr, false, 0},
    //    {"HeapCreate",	(FARPROC) WINWRAPPER_PREFIX(HeapWalk),false, 0},
    //    {"HeapDestroy",	(FARPROC) WINWRAPPER_PREFIX(HeapWalk),false, 0},
    {"HeapFree",	(FARPROC) WINWRAPPER_PREFIX(HeapFree), nullptr, false, 0},
    // HeapLock
    // HeapQueryInformation
    {"HeapReAlloc",	(FARPROC) WINWRAPPER_PREFIX(HeapReAlloc), nullptr, false, 0},
    // HeapSetInformation
    {"HeapSize",	(FARPROC) WINWRAPPER_PREFIX(HeapSize), nullptr, false, 0},
    // HeapUnlock
    {"HeapValidate",	(FARPROC) WINWRAPPER_PREFIX(HeapValidate), nullptr, false, 0},
    {"HeapWalk",	(FARPROC) WINWRAPPER_PREFIX(HeapWalk), nullptr, false, 0}
#endif
